...
error_msgs = {
    'msg_no_user': json.dumps({"code": 201, "msg": "账户不存在", "data": {}}),
    'msg_no_plan': json.dumps({"code": 201, "msg": "测试计划不存在", "data": {}}),
    'msg_no_test_task': json.dumps({"code": 201, "msg": "无测试任务", "data": {}}),
    'msg_no_assign': json.dumps({"code": 201, "msg": "无分配记录", "data": {}}),
    'msg_no_table': json.dumps({"code": 201, "msg": "测试计划工作台无内容", "data": {}}),
    'msg_too_early': json.dumps({"code": 201, "msg": "测试任务开始时间过早", "data": {}}),
    'msg_worker_not_exist': json.dumps({"code": 201, "msg": "worker不存在", "data": {}}),
    'msg_no_case': json.dumps({"code": 201, "msg": "测试用例不存在", "data": {}}),
    'msg_no_version': json.dumps({"code": 201, "msg": "未找到测试计划的版本", "data": {}}),
    'msg_no_plan_type': json.dumps({"code": 201, "msg": "测试计划类型不存在", "data": {}}),
    'msg_no_task': json.dumps({"code": 201, "msg": "任务不存在", "data": {}}),
    'msg_plan_notopen': json.dumps({"code": 201, "msg": "测试计划未开放", "data": {}}),
    'msg_data_error': json.dumps({"code": 201, "msg": "数据非法", "data": {}}),
    'msg_no_role_auth_data': json.dumps({"code": 201, "msg": "账户所属角色无权限数据", "data": {}}),
    'msg_be_forbidden': json.dumps({"code": 201, "msg": "账户已禁用", "data": {}}),
    'msg_no_auth': json.dumps({"code": 201, "msg": "账户无访问权限", "data": {}}),
    'msg_status_error': json.dumps({"code": 201, "msg": "账户状态异常", "data": {}}),
    'msg_need_register': json.dumps({"code": 201, "msg": "账户未激活", "data": {}}),
    'msg_before_login': json.dumps({"code": 201, "msg": "请先登录账号", "data": {}}),
    'msg_token_wrong': json.dumps({"code": 201, "msg": "Token校验失败", "data": {}}),
    'msg_token_expired': json.dumps({"code": 201, "msg": "Token过期", "data": {}}),
    'msg_request_body_not_json': json.dumps({"code": 301, "msg": "传参格式非法", "data": {}}),
    'msg_value_type_error': json.dumps({"code": 301, "msg": "传参格式非法", "data": {}}),
    'msg_lack_keys': json.dumps({"code": 302, "msg": "缺少必传参数", "data": {}}),
    'msg_json_format_fail': json.dumps({"code": 500, "msg": "缓存处理失败", "data": {}}),
    'msg_db_error': json.dumps({"code": 500, "msg": "数据查询失败", "data": {}}),
    'msg_tasktype_error': json.dumps({"code": 201, "msg": "调试任务不支持查看此报告", "data": {}}),
    'msg_plantype_error': json.dumps({"code": 201, "msg": "自动化功能测试任务不支持查看此报告", "data": {}}),
    'msg_no_worker': json.dumps({"code": 500, "msg": "当前无可用worker", "data": {}}),
    'msg_file_error': json.dumps({"code": 500, "msg": "文件操作失败", "data": {}}),
    'msg_deploy_failed': json.dumps({"code": 500, "msg": "测试任务下发失败，请尽快联系管理员", "data": {}})
}
